...
parser.add_argument("--task", type=str, default='Template-Roboduet-v0', help="Name of the task.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    runner = OnPolicyRunnerDuet(env, agent_cfg.to_dict(), log_dir=log_dir, device=agent_cfg.device)
