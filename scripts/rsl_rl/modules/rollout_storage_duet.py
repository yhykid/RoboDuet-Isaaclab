...
import torch
from rsl_rl.utils.utils import split_and_pad_trajectories

class RolloutStorageDuet:
    class Transition:
        def __init__(self):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield obs_batch, critic_observations_batch, privileged_obs_batch, obs_history_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, \
                       old_actions_log_prob_batch, old_mu_batch, old_sigma_batch,(None,None), None, env_bins_batch , rnd_state_batch
